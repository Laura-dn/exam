...
<head>
    ...
    <link rel="stylesheet" href="../view/homePage/templates/css/style.css">
</head>
<body>
<header class="index_10">
    <section class="heading index_12">
        ...
        <section class="entrySalon index_2">
            <button id="entrySalon" class="index_12">ЗАПИСАТЬСЯ В САЛОН</button>
...
<nav class="index_12">
        <a href="home" class="menuItem itemHome">ГЛАВНАЯ</a>
